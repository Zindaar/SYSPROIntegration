...
Namespace PurchaseOrderRequistionSystem.RouteRequisition.Data
    ...
    Partial Public Class Item
        ...
        '''<summary>
        '''The user who is routing the requisition. If the user is not supplied then the user associated with the operator will be assumed. 
        '''The user must be the current holder of the requisition to be able to route it to another user.
        '''</summary>
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true),  _
     System.Xml.Serialization.XmlRootAttribute([Namespace]:="", IsNullable:=false)>  _
    Partial Public Class PostReqRoute
