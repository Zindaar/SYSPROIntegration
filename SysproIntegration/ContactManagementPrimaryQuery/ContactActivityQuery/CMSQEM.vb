...
Namespace ContactManagementPrimaryQuery.ContactActivityQuery.QueryData
    ...
    Public Enum Email
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlEnumAttribute("HELEN.KOPELOWITZ@BAYSIDE.COM")>  _
        HELENKOPELOWITZBAYSIDECOM
        
        '''<remarks/>
        <System.Xml.Serialization.XmlEnumAttribute("JAMES.PADDINGTON@BAYSIDE.COM")>  _
        JAMESPADDINGTONBAYSIDECOM
        
        '''<remarks/>
        <System.Xml.Serialization.XmlEnumAttribute("PETER@UNKNOWN.COM")>  _
        PETERUNKNOWNCOM
    End Enum
    ...
    Partial Public Class Key
        ...
        Private emailField As List(Of Email)
        
        Public Sub New()
            MyBase.New
            If (Me.emailField Is Nothing) Then
                Me.emailField = New List(Of Email)
            End If
        End Sub
        
        '''<summary>
        '''The email address of contact that must be returned. The value must be in upper case and can occur multiple times.
        '''</summary>
        <System.Xml.Serialization.XmlElementAttribute("Email")>  _
        Public Property EmailCollection() As List(Of Email)
            Get
    ...
    Partial Public Class Query
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private keyField As List(Of Email)
        ...
        Public Property KeyCollection() As List(Of Email)
            Get
                Return Me.keyField
            End Get
            Set
