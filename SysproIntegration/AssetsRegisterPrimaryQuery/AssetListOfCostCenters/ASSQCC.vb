...
Namespace AssetsRegisterPrimaryQuery.AssetListOfCostCenters.QueryData
    ...
    Partial Public Class CostCenter
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private filterTypeField As CostCenterFilterType
        ...
        Public Sub New()
            MyBase.New
            Me.filterTypeField = CostCenterFilterType.A
        End Sub
        
        <System.Xml.Serialization.XmlAttributeAttribute(),  _
         System.ComponentModel.DefaultValueAttribute(CostCenterFilterType.A)>  _
        Public Property FilterType() As CostCenterFilterType
            Get
                Return Me.filterTypeField
            End Get
            Set
    ...
    Partial Public Class Filter
        ...
        '''<summary>
        '''Branch to be selected. A=All, S=Single, R=Range
        '''</summary>
