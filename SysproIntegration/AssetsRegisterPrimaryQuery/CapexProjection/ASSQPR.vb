...
Namespace AssetsRegisterPrimaryQuery.CapexProjection.QueryData
    ...
    Partial Public Class AssetCode
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private filterTypeField As AssetCodeFilterType
        ...
        Public Sub New()
            MyBase.New
            Me.filterTypeField = AssetCodeFilterType.A
        End Sub
        
        <System.Xml.Serialization.XmlAttributeAttribute(),  _
         System.ComponentModel.DefaultValueAttribute(AssetCodeFilterType.A)>  _
        Public Property FilterType() As AssetCodeFilterType
            Get
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true),  _
     System.Xml.Serialization.XmlRootAttribute([Namespace]:="", IsNullable:=false)>  _
    Partial Public Class CapexLine
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private filterTypeField As CapexLineFilterType
        ...
        Public Sub New()
            MyBase.New
            Me.filterTypeField = CapexLineFilterType.A
        End Sub
        
        <System.Xml.Serialization.XmlAttributeAttribute(),  _
         System.ComponentModel.DefaultValueAttribute(CapexLineFilterType.A)>  _
        Public Property FilterType() As CapexLineFilterType
            Get
                Return Me.filterTypeField
            End Get
            Set
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true),  _
     System.Xml.Serialization.XmlRootAttribute([Namespace]:="", IsNullable:=false)>  _
    Partial Public Class CapexType
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private filterTypeField As CapexTypeFilterType
        ...
        Public Sub New()
            MyBase.New
            Me.filterTypeField = CapexTypeFilterType.A
        End Sub
        
        <System.Xml.Serialization.XmlAttributeAttribute(),  _
         System.ComponentModel.DefaultValueAttribute(CapexTypeFilterType.A)>  _
        Public Property FilterType() As CapexTypeFilterType
            Get
                Return Me.filterTypeField
            End Get
            Set
    ...
    Partial Public Class Filter
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private capexLineField As CapexLine
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private capexTypeField As CapexType
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private assetCodeField As AssetCode
        ...
        Public Sub New()
            ...
            End If
            If (Me.assetCodeField Is Nothing) Then
                Me.assetCodeField = New AssetCode
            End If
            If (Me.capexTypeField Is Nothing) Then
                Me.capexTypeField = New CapexType
            End If
            ...
            End If
            If (Me.capexLineField Is Nothing) Then
                Me.capexLineField = New CapexLine
            End If
        ...
        '''<summary>
        '''All,  Single, Range of capex lines to be returned.  FilterType options - A(All), (S)Single, (R)Range. Default to A(All).
        '''</summary>
        Public Property CapexLine() As CapexLine
            Get
        ...
        '''<summary>
        '''All,  Single, Range of branches to be returned.  FilterType options - A(All), (S)Single, (R)Range. Default to A(All).
        '''</summary>
        ...
        '''<summary>
        '''All,  Single, Range of capex types to be returned.  FilterType options - A(All), (S)Single, (R)Range. Default to A(All).
        '''</summary>
        Public Property CapexType() As CapexType
            Get
        ...
        '''<summary>
        '''All,  Single, Range of asset codes to be returned.  FilterType options - A(All), (S)Single, (R)Range. Default to A(All).
        '''</summary>
        Public Property AssetCode() As AssetCode
            Get
                Return Me.assetCodeField
            End Get
            Set
                Me.assetCodeField = value
            End Set
        End Property
    ...
    Partial Public Class [Option]
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private useItemFieldsField As UseItemFields
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private includeNoLinesField As IncludeNoLines
        ...
        '''<summary>
        '''Indicates whether to use the branch, cost center and group fields from the Capex item, or to use the branch, cost center and group from the individual capex lines. (Y - yes and N - No). If no value is supplied then a default value of 'Y' will be used. 
        '''</summary>
        Public Property UseItemFields() As UseItemFields
            Get
        ...
        '''<summary>
        '''Indicates whether to include capex items which have no capex lines created for them. (N - No and Y - Yes). If no value is supplied then a default value of 'N' will be used. 
        '''</summary>
        Public Property IncludeNoLines() As IncludeNoLines
            Get
        ...
        '''<summary>
        '''Indicates whether print all the capex lines included in the report.  (Y - yes and N - No). If no value is supplied then a default value of 'Y' will be used. The value "N" will serve to summarize the report.
        '''</summary>
        Public Property PrintLines() As PrintLines
            Get
