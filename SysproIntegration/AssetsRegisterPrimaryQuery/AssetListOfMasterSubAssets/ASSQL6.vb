...
Namespace AssetsRegisterPrimaryQuery.AssetListOfMasterSubAssets.QueryData
    ...
    Partial Public Class Master
        ...
        Private filterTypeField As MasterFilterType
        ...
        Public Sub New()
            MyBase.New
            Me.filterTypeField = MasterFilterType.A
        End Sub
        
        <System.Xml.Serialization.XmlAttributeAttribute(),  _
         System.ComponentModel.DefaultValueAttribute(MasterFilterType.A)>  _
        Public Property FilterType() As MasterFilterType
            Get
    ...
    Partial Public Class Filter
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private masterField As Master
        
        Public Sub New()
            MyBase.New
            If (Me.masterField Is Nothing) Then
                Me.masterField = New Master
            End If
        End Sub
        
        '''<summary>
        '''Master Asset to be selected. A=All, S=Single, R=Range
        '''</summary>
