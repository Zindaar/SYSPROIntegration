...
Namespace AssetsRegisterPrimaryQuery.AssetListOfDepreciationAdjustments.QueryData
    ...
    Partial Public Class QueryFilter
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private periodField As QueryFilterPeriod
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private assetField As QueryFilterAsset
        
        Public Sub New()
            MyBase.New
            If (Me.assetField Is Nothing) Then
                Me.assetField = New QueryFilterAsset
            End If
            If (Me.periodField Is Nothing) Then
                Me.periodField = New QueryFilterPeriod
            End If
        End Sub
        
        Public Property Period() As QueryFilterPeriod
            Get
        ...
        Public Property Asset() As QueryFilterAsset
            Get
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true)>  _
    Partial Public Class QueryFilterPeriod
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true)>  _
    Partial Public Class QueryFilterAsset
