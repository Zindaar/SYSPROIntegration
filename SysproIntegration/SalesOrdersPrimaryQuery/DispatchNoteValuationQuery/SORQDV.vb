...
Namespace SalesOrdersPrimaryQuery.DispatchNoteValuationQuery.QueryData
    ...
    Partial Public Class Key
        ...
        '''<summary>
        '''Enter the dispatch note(key) on file. If the key (dispatch note) is empty or if the dispatch note is not valid. - error message will show.
        '''
        '''</summary>
    ...
    Partial Public Class Query
        ...
        '''<summary>
        '''The key consists of only one element, the dispatch note. 
        '''</summary>
