...
#Region " Private Variables "
        Private _LineType As DispatchInvoiceLineTypeEnum = DispatchInvoiceLineTypeEnum.MiscCharge
        ...
        Private _NMscProductCls As String = ""
...
#End Region
        ...
        Public Shared Function NewFromDataRow(ByVal rootRow As DataRow) As MiscChargeLine
            ...
            Dim merchLine As New MiscChargeLine
            ...
            With merchLine
                ...
                Try : .NMscProductCls = rootRow.Item("NMscProductCls").ToString : Catch ex As ArgumentException : End Try
