...
Namespace SalesOrdersPrimaryQuery.TpmPromotionDetailQuery.QueryData
    ...
    Partial Public Class Filter
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private promotionField As Promotion
        ...
        Public Sub New()
            MyBase.New
            If (Me.invoiceField Is Nothing) Then
                Me.invoiceField = New Invoice()
            End If
            ...
            End If
            If (Me.promotionField Is Nothing) Then
                Me.promotionField = New Promotion()
            End If
        ...
        '''<summary>
        '''Range of promotions to be selected.
        '''Valid values are 'A' - All (default), 'R' - Range and 'S' - Single'
        '''
        '''Enter a range of promotions if Range selected.
        '''
        '''Enter a single promotion if Single selected.
        '''</summary>
        ...
        '''<summary>
        '''Range of sales orders to be selected.
        '''Valid values are 'A' - All (default), 'R' - Range and 'S' - Single'
        '''
        '''Enter a range of sales orders if Range selected.
        '''
        '''Enter a single sales order if Single selected.
        '''</summary>
        ...
        '''<summary>
        '''Range of stock codes to be selected.
        '''Valid values are 'A' - All (default), 'R' - Range and 'S' - Single'
        '''
        '''Enter a range of stock codes if Range selected.
        '''
        '''Enter a single stock code if Single selected.
        '''</summary>
        ...
        '''<summary>
        '''Range of invoices to be selected.
        '''Valid values are 'A' - All (default), 'R' - Range and 'S' - Single'
        '''
        '''Enter a range of invoices if Range selected.
        '''
        '''Enter a single invoice if Single selected.
        '''</summary>
    ...
    Partial Public Class [Option]
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private includeOffInvoicePromotionsField As IncludeOffInvoicePromotions
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private includeAccrualPromotionsField As IncludeAccrualPromotions
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private includeFreeGoodsPromotionsField As IncludeFreeGoodsPromotions
        ...
        Public Sub New()
            MyBase.New
            Me.sequenceField = Sequence.I
            Me.includeOffInvoicePromotionsField = IncludeOffInvoicePromotions.Y
            Me.includeAccrualPromotionsField = IncludeAccrualPromotions.Y
            Me.includeFreeGoodsPromotionsField = IncludeFreeGoodsPromotions.Y
        ...
        '''<summary>
        '''Sequence required.
        '''Valid values are 'I' - Invoice (default), 'C' - Customer and 'P' - Promotion.
        '''</summary>
        ...
        '''<summary>
        '''Include Off Invoice promotions.
        '''Valid values are 'Y' - Yes (default) and 'N' - No.
        '''</summary>
        Public Property IncludeOffInvoicePromotions() As IncludeOffInvoicePromotions
            Get
                Return Me.includeOffInvoicePromotionsField
            End Get
            Set
                Me.includeOffInvoicePromotionsField = value
            End Set
        End Property
        
        '''<summary>
        '''Include Accrual promotions.
        '''Valid values are 'Y' - Yes (default) and 'N' - No.
        '''</summary>
        Public Property IncludeAccrualPromotions() As IncludeAccrualPromotions
            Get
                Return Me.includeAccrualPromotionsField
            End Get
            Set
                Me.includeAccrualPromotionsField = value
            End Set
        End Property
        
        '''<summary>
        '''Include Free Goods promotions.
        '''Valid values are 'Y' - Yes (default) and 'N' - No.
        '''</summary>
        Public Property IncludeFreeGoodsPromotions() As IncludeFreeGoodsPromotions
            Get
                Return Me.includeFreeGoodsPromotionsField
            End Get
            Set
                Me.includeFreeGoodsPromotionsField = value
            End Set
        End Property
