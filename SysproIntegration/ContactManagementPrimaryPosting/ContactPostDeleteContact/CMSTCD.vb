...
Namespace ContactManagementPrimaryPosting.ContactPostDeleteContact.Params
    ...
    Partial Public Class PostContactParameters
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private alwaysApplyAllField As Object
        ...
        Public Property AlwaysApplyAll() As Object
            Get
