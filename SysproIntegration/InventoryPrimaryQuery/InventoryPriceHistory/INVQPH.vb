...
Namespace InventoryPrimaryQuery.InventoryPriceHistory.QueryData
    ...
    Partial Public Class QueryFilter
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private dateChangedField As QueryFilterDateChanged
        
        Public Sub New()
            MyBase.New
            If (Me.dateChangedField Is Nothing) Then
                Me.dateChangedField = New QueryFilterDateChanged
            End If
        ...
        Public Property DateChanged() As QueryFilterDateChanged
            Get
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true)>  _
    Partial Public Class QueryFilterDateChanged
