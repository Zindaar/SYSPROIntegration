...
Namespace TransactionObjects.Requisition
    <Serializable()> Public Class RequisitionItem
...
#End Region
        ...
        Public Sub AppendRequisitionItem(ByRef xmlDoc As System.Xml.XmlDocument)

            Dim ItemFragment As System.Xml.XmlDocumentFragment = xmlDoc.CreateDocumentFragment
            ...
            xmlDoc.DocumentElement.SelectSingleNode("//PostRequisition").AppendChild(ItemFragment)
