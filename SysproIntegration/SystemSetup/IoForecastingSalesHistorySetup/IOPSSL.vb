...
Namespace SystemSetup.IoForecastingSalesHistorySetup.Params
    ...
    Partial Public Class Parameters
        ...
        '''<summary>
        '''This element indicates whether or not a transaction must be rejected if there are any warnings. If not supplied it defaults to 'N'. Valid values are 'N' and 'Y'.
        '''</summary>
