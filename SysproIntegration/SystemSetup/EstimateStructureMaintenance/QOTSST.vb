...
Namespace SystemSetup.EstimateStructureMaintenance.Params
    ...
    Partial Public Class Parameters
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private estimateStatusField As EstimateStatus
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private estimateStatusFieldSpecified As Boolean
        ...
        Public Sub New()
            ...
            Me.estimateStatusField = EstimateStatus.U
        End Sub
        ...
        '''<summary>
        '''Specifies whether the entire document must be validated first before applying the function (N - apply function for each valid item, Y - all items must be valid before function is applied). NOTE it is not advised to set this on to process a single item as it causes the program to pass through the same routines twice.
        '''</summary>
        ...
        '''<summary>
        '''This indicates the status of the estimate that you are adding or maintaining. Possible values: ‘A’ (to make the estimate available for use in a quotation) or ‘U’ (to set the status to unavailable - under development).
        '''</summary>
        Public Property EstimateStatus() As EstimateStatus
            Get
                Return Me.estimateStatusField
            End Get
            Set
                Me.estimateStatusField = value
                Me.EstimateStatusFieldSpecified = true
            End Set
        End Property
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property EstimateStatusSpecified() As Boolean
            Get
                Return Me.estimateStatusFieldSpecified
            End Get
        End Property
    End Class
