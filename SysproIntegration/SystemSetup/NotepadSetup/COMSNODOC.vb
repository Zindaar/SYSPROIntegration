...
Namespace SystemSetup.NotepadSetup.Data
    ...
    Partial Public Class Item
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private notepadTextField As String
        ...
        '''<summary>
        '''This field contains the item key upon which a setup method is performed. The fields that make up the key are MultimediaFlag, KeyField and ObjectType.
        '''</summary>
        ...
        '''</summary>
        Public Property NotepadText() As String
            Get
                Return Me.notepadTextField
            End Get
            Set
                Me.notepadTextField = value
            End Set
        End Property
    End Class
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true),  _
     System.Xml.Serialization.XmlRootAttribute([Namespace]:="", IsNullable:=false)>  _
    Partial Public Class SetupNotepad
        ...
        '''<summary>
        '''This element contains all the pertinent information regarding the notepad type and content.
        '''</summary>
