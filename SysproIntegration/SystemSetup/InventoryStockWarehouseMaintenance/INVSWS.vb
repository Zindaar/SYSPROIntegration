...
Namespace SystemSetup.InventoryStockWarehouseMaintenance.Params
    ...
    Partial Public Class Parameters
        ...
        '''<summary>
        ''' If adding warehouses for stock codes and using product class defaults then enter the product class that holds these defaults. Format is 4 characters alphanumeric.
        '''</summary>
