...
Namespace InventoryInspectionSystem.GoodsInInspectionScraps.Params
    ...
    Partial Public Class Parameters
        ...
        '''<summary>
        '''This element indicates whether or not a transaction must be rejected if there are any warnings, such as a ledger control account supplied or a stock code on partial hold. If 'W' supplied, these errors will be reported as warnings. If it is not supplied, it defaults to 'N'. Valid values are 'N', 'W' and 'Y'.
        '''</summary>
