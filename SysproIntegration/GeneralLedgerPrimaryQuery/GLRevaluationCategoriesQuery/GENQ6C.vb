...
Namespace GeneralLedgerPrimaryQuery.GLRevaluationCategoriesQuery.QueryData
    ...
    Partial Public Class Filter
        ...
        Private glCategoryField As GlCategory
        
        Public Sub New()
            MyBase.New
            If (Me.glCategoryField Is Nothing) Then
                Me.glCategoryField = New GlCategory
            End If
        End Sub
        
        '''<summary>
        '''All,  Single selection of G/L Categories to be returned. FilterType options - A(All), (R) Range, (S)Single. Default to A(All).
        '''</summary>
        Public Property GlCategory() As GlCategory
            Get
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("Shell", "1.0.0.0"),  _
     ...
     System.Xml.Serialization.XmlTypeAttribute(AnonymousType:=true),  _
     System.Xml.Serialization.XmlRootAttribute([Namespace]:="", IsNullable:=false)>  _
    Partial Public Class GlCategory
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private filterTypeField As GlCategoryFilterType
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private filterValueField As String
        
        <System.Xml.Serialization.XmlAttributeAttribute()>  _
        Public Property FilterType() As GlCategoryFilterType
            Get
