...
Namespace GeneralLedgerPrimaryQuery.GLSalesLedgerInterfaceQuery.QueryData
    ...
    Partial Public Class Filter
        ...
        '''<summary>
        '''All, Range or Single selection of Branch to be returned. FilterType options - A(All), (R) Range, (S)Single. Default to A(All).
        '''</summary>
