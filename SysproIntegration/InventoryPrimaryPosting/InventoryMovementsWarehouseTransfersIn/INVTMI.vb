...
Namespace InventoryPrimaryPosting.InventoryMovementsWarehouseTransfersIn.Params
    ...
    Partial Public Class Parameters
        ...
        '''<summary>
        '''This element indicates whether or not a transaction must be rejected if there are any warnings such as a stock item being on hold.If 'W' is supplied, the error is reported as a warning. If not supplied it defaults to 'N'. Valid values are 'N', 'W' and 'Y'.
        '''</summary>
