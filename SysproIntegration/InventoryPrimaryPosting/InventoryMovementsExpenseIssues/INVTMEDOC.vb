...
Namespace InventoryPrimaryPosting.InventoryMovementsExpenseIssues.Data
    ...
    Partial Public Class PostInvExpenseIssues
        ...
        Public Overridable ReadOnly Property XmlParam() As String Implements ITransaction.XmlParam
            Get
                Dim objParams As Params.PostInvExpenseIssues
                objParams = New Params.PostInvExpenseIssues
    ...
    Partial Public Class Item
        ...
        '''<summary>
        '''This element is mandatory and it must stock the specified stock item.
        '''</summary>
        ...
        '''<summary>
        '''A set of serial numbers and relevant quantities to process must be supplied if stock item is serialized.
        '''</summary>
