...
Namespace InventoryPrimaryPosting.InventoryMovementsWarehouseTransfersOut.Params
    ...
    Partial Public Class Parameters
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private createDestinationWarehouseField As CreateDestinationWarehouse
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private createDestinationWarehouseFieldSpecified As Boolean
        ...
        Public Sub New()
            ...
            Me.createDestinationWarehouseField = CreateDestinationWarehouse.N
        ...
        '''<summary>
        '''This element indicates whether or not a transaction must be rejected if there are any warnings such stock item on hold. If 'W' suplpied, the error is reported as a warning. If not supplied it defaults to 'N'. Valid values are 'N', 'W' and 'Y.
        '''</summary>
        ...
        '''<summary>
        '''This element indicates whether a destination warehouse must be created, if it does not exist. If it is not supplied, it defaults to 'N'. Valid values are 'N' and 'Y'.
        '''</summary>
        Public Property CreateDestinationWarehouse() As CreateDestinationWarehouse
            Get
                Return Me.createDestinationWarehouseField
            End Get
            Set
                Me.createDestinationWarehouseField = value
                Me.CreateDestinationWarehouseFieldSpecified = true
            End Set
        End Property
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property CreateDestinationWarehouseSpecified() As Boolean
            Get
                Return Me.createDestinationWarehouseFieldSpecified
            End Get
        End Property
