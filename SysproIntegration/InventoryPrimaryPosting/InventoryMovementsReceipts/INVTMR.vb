...
Namespace InventoryPrimaryPosting.InventoryMovementsReceipts.Params
    ...
    Partial Public Class Parameters
        ...
        '''<summary>
        '''If a manual serial number exists in a different warehouse with no stock on hand it may be transferred to the warehouse where it is required. To do this, this element may be set to 'Y'. Valid values are 'N' and 'Y'. Default is 'N'.
        '''</summary>
