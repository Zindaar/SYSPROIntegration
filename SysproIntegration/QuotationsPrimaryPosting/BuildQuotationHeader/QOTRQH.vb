...
Namespace QuotationsPrimaryPosting.BuildQuotationHeader.BuildData
    ...
    Partial Public Class Parameters
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private addressCodeField As String
        
        '''<summary>
        '''Enter the customer account code to be used to retrieve the required data. The customer defaults will be returned if the customer element is left blank.
        '''</summary>
        ...
        '''<summary>
        '''Enter the address code for the ship to address to be retrieved when the customer has more than one ship to address defined. The ship to address from the customer master will be returned if the address code element is left blank
        '''</summary>
        Public Property AddressCode() As String
            Get
                Return Me.addressCodeField
            End Get
            Set
                Me.addressCodeField = value
            End Set
        End Property
    End Class
End Namespace
