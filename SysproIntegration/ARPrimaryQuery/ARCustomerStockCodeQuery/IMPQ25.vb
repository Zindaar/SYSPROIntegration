...
Namespace ARPrimaryQuery.ARCustomerStockCodeQuery.QueryData
    ...
    Partial Public Class Filter
        ...
        '''<summary>
        '''All, Range, Single selection of Bank to be returned. FilterType options - A(All), Range(R), (S)Single. Default to A(All).
        '''</summary>
    ...
    Partial Public Class [Option]
        ...
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private newPagePerCustomerField As NewPagePerCustomer
        
        <EditorBrowsable(EditorBrowsableState.Never)>  _
        Private newPagePerCustomerFieldSpecified As Boolean
        ...
        '''<summary>
        '''Indicates whether a page break should occur after each customer. (Y - Yes, N - No. If no value is supplied then a default value of 'N' will be used.
        '''</summary>
        Public Property NewPagePerCustomer() As NewPagePerCustomer
            Get
                Return Me.newPagePerCustomerField
            End Get
            Set
                Me.newPagePerCustomerField = value
                Me.NewPagePerCustomerFieldSpecified = true
            End Set
        End Property
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnoreAttribute()>  _
        Public ReadOnly Property NewPagePerCustomerSpecified() As Boolean
            Get
                Return Me.newPagePerCustomerFieldSpecified
            End Get
        End Property
