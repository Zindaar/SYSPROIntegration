...
Namespace ARPrimaryQuery.ARMasterSubAccountQuery.QueryData
    ...
    Partial Public Class Filter
        ...
        '''<summary>
        '''All, Range or Single selection of Customer to be returned. FilterType options - A(All), (R) Range, (S)Single. Default to A(All).
        '''</summary>
