...
Imports Codewell.SysproIntegration.SalesOrdersPrimaryPosting.BuildSalesOrderLine.BuildData
...
#End Region
    ...
    Public Sub PostTest()
        ...
        Dim target As Build = New Build
        Dim blnThrowExceptionOnErrorInXMLOut As Boolean = True
        With target.Parameters
            .Customer = "ARM870"
            .StockCode = "21.D060778.060"
            .Warehouse = "2B"
        End With
